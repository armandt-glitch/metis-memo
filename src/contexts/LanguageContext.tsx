...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'dashboard.thematic.quiz.desc': 'Sélectionnez un groupe pour lancer un quizz sur toutes les fiches du groupe',
    ...
    // Pack Creator
    'pack.creator.title': 'Créer un pack',
    'pack.creator.subtitle': 'Créez un pack de fiches à partager avec la communauté',
    'pack.creator.info': 'Informations du pack',
    'pack.creator.packTitle': 'Titre du pack',
    'pack.creator.titlePlaceholder': 'Ex: Vocabulaire anglais B2',
    'pack.creator.description': 'Description',
    'pack.creator.descriptionPlaceholder': 'Décrivez le contenu de votre pack...',
    'pack.creator.theme': 'Thème',
    'pack.creator.selectTheme': 'Sélectionner un thème',
    'pack.creator.level': 'Niveau',
    'pack.creator.tags': 'Tags',
    'pack.creator.tagPlaceholder': 'Ajouter un tag...',
    'pack.creator.cards': 'Fiches',
    'pack.creator.addExisting': 'Ajouter existantes',
    'pack.creator.addNew': 'Nouvelle fiche',
    'pack.creator.noCards': 'Aucune fiche ajoutée. Ajoutez des fiches existantes ou créez-en de nouvelles.',
    'pack.creator.selectExisting': 'Sélectionner des fiches existantes',
    'pack.creator.noExisting': 'Aucune fiche existante',
    'pack.creator.addSelected': 'Ajouter les fiches sélectionnées',
    'pack.creator.question': 'Question',
    'pack.creator.answer': 'Réponse',
    'pack.creator.questionPlaceholder': 'Entrez la question...',
    'pack.creator.answerPlaceholder': 'Entrez la réponse...',
    'pack.creator.cardType': 'Type',
    'pack.creator.publish': 'Publier le pack',
    'pack.creator.publishing': 'Publication...',
    'pack.creator.success': 'Pack soumis pour approbation !',
    'pack.creator.error.title': 'Le titre est requis',
    'pack.creator.error.description': 'La description est requise',
    'pack.creator.error.minCards': 'Le pack doit contenir au moins 3 fiches',
  ...
  en: {
    ...
    'dashboard.thematic.quiz.desc': 'Select a group to start a quiz with all cards in the group',
    ...
    // Pack Creator
    'pack.creator.title': 'Create a pack',
    'pack.creator.subtitle': 'Create a flashcard pack to share with the community',
    'pack.creator.info': 'Pack information',
    'pack.creator.packTitle': 'Pack title',
    'pack.creator.titlePlaceholder': 'E.g: English vocabulary B2',
    'pack.creator.description': 'Description',
    'pack.creator.descriptionPlaceholder': 'Describe the content of your pack...',
    'pack.creator.theme': 'Theme',
    'pack.creator.selectTheme': 'Select a theme',
    'pack.creator.level': 'Level',
    'pack.creator.tags': 'Tags',
    'pack.creator.tagPlaceholder': 'Add a tag...',
    'pack.creator.cards': 'Cards',
    'pack.creator.addExisting': 'Add existing',
    'pack.creator.addNew': 'New card',
    'pack.creator.noCards': 'No cards added. Add existing cards or create new ones.',
    'pack.creator.selectExisting': 'Select existing cards',
    'pack.creator.noExisting': 'No existing cards',
    'pack.creator.addSelected': 'Add selected cards',
    'pack.creator.question': 'Question',
    'pack.creator.answer': 'Answer',
    'pack.creator.questionPlaceholder': 'Enter the question...',
    'pack.creator.answerPlaceholder': 'Enter the answer...',
    'pack.creator.cardType': 'Type',
    'pack.creator.publish': 'Publish pack',
    'pack.creator.publishing': 'Publishing...',
    'pack.creator.success': 'Pack submitted for approval!',
    'pack.creator.error.title': 'Title is required',
    'pack.creator.error.description': 'Description is required',
    'pack.creator.error.minCards': 'Pack must contain at least 3 cards',
